        ...
        <div class="admin-container">
            <div class="admin-content">
                ...
                <div class="form-container">
                    ...
                    <form method="POST" action="<?= APP_URL ?>/contents/create" enctype="multipart/form-data" id="content-form" class="styled-form">
                        ...
                        <div class="form-card">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                <div class="form-group" @if(request('parent_id')) style="display: none;" @endif id="content-group">
                                    <label for="content">Contenido</label>
                                    <textarea name="content" id="content" class="form-control" rows="10">{{ old('content') }}</textarea>
                                </div>
                                <div class="form-group" @if(request('parent_id')) style="display: none;" @endif id="image-group">
                                    <label for="image_file">Imagen</label>
