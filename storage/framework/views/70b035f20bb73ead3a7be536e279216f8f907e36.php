                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($slide->image_path): ?>
                                    <img src="<?php echo e(asset('uploads/images/' . $slide->image_path)); ?>" alt="<?php echo e($slide->title); ?>" style="width: 90px; border-radius:8px; box-shadow:0 2px 8px rgba(0,158,96,0.10);">
                                <?php endif; ?>
                            </td>
