            ...
            <form action="<?php echo e(route('admin.academic_modalities.programs.update', [$modality->id, $academicProgram->id])); ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <?php if($academicProgram->document): ?>
                        <div class="mb-2">
                            <a href="<?php echo e(asset('storage/' . $academicProgram->document)); ?>" target="_blank">Ver PDF actual</a>
                        </div>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\worspace\ISTSSYSTEM\resources\views/admin/academic_programs/edit.blade.php ENDPATH**/ ?>