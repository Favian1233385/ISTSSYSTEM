        ...
        <nav class="main-navigation">
            <div class="container">
                <ul class="nav-menu">
                        ...
                        <div class="dropdown-content">
                            ...
                            <div class="dropdown-grid">
                                <div class="dropdown-column">
                                    ...
                                    <ul>
                                        <li><a href="{{ url('/academicos/desarrollo-software') }}">Desarrollo de Software</a></li>
                                        <li><a href="{{ url('/academicos/contabilidad') }}">Contabilidad y Asesoría Tributaria</a></li>
                                        <li><a href="{{ url('/academicos/agroecologia') }}">Agroecología</a></li>
                                        <li><a href="{{ url('/academicos/educacion-inicial') }}">Educación Inicial</a></li>
                                    </ul>
                                </div>
                                <div class="dropdown-column">
                    ...
                    <li class="nav-item dropdown">
                        <a href="{{ url('/enfoque') }}" class="nav-link">Enfoque</a>
                        <div class="dropdown-content">
                            <div class="dropdown-section">
                                <h3>En Enfoque</h3>
                            ...
                            <div class="dropdown-grid">
                                <div class="dropdown-column">
                                    ...
                                    <ul>
                                        <li><a href="{{ url('/enfoque/desarrollo-software') }}">¿Qué hay dentro?</a></li>
                                        <li><a href="{{ url('/enfoque/programacion') }}">¿Por qué eres tan bueno programando?</a></li>
                                    </ul>
                                </div>
                                <div class="dropdown-column">
                                    ...
                                    <ul>
                                        <li><a href="{{ url('/enfoque/salud-digital') }}">Explora la salud digital en ISTS</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <li class="nav-item">
                        <a href="{{ url('/noticias') }}" class="nav-link">Egresados</a>
                    </li>
                </ul>
            </div>
        </nav>
