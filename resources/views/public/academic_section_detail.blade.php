            ...
            <div class="programs-list" style="margin-top: 3rem;">
                ...
                <div style="display: flex; flex-direction: column; gap: 1rem;">
                    @foreach($section->careers as $program)
                        <a href="{{ route('inscripcion.create', $program->id) }}" style="text-decoration: none; color: inherit; display: block; padding: 1.5rem; border: 1px solid #ddd; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.05); transition: all 0.2s ease-in-out;">
                            ...
                            @endif
                            <span style="background-color: #007bff; color: white; border: none; padding: 0.5rem 1rem; border-radius: 5px; cursor: pointer;">Inscribirse</span>
                        </a>
                    @endforeach
                </div>
            </div>
