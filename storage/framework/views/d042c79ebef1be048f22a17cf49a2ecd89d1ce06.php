            ...
            <div class="footer-section">
                ...
                <div class="social-links">
                    <a href="https://facebook.com/istsucua" aria-label="Facebook" target="_blank" rel="noopener">
                        <img src="<?php echo e(asset('assets/images/footer/facebook.png')); ?>" alt="Facebook" width="32" height="32">
                    </a>
                    <a href="https://x.com/istsucua" aria-label="X" target="_blank" rel="noopener">
                        <img src="<?php echo e(asset('assets/images/footer/x.png')); ?>" alt="X (Twitter)" width="32" height="32">
                    </a>
                    <a href="https://instagram.com/istsucua" aria-label="Instagram" target="_blank" rel="noopener">
                        <img src="<?php echo e(asset('assets/images/footer/instagram.png')); ?>" alt="Instagram" width="32" height="32">
                    </a>
                    <a href="https://tiktok.com/@ist_sucua" aria-label="TikTok" target="_blank" rel="noopener">
                        <img src="<?php echo e(asset('assets/images/footer/tiktok.png')); ?>" alt="TikTok" width="32" height="32">
                    </a>
                </div>
            </div>
