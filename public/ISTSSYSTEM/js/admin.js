...
function initAdminFeatures() {
    ...
    const deleteButtons = document.querySelectorAll('[href*="delete"], [onclick*="confirm"]');
...
function initRichTextEditor() {
    ...
    textareas.forEach(textarea => {
        // Crear toolbar básico
        const toolbar = document.createElement('div');
        toolbar.className = 'rich-editor-toolbar';
        toolbar.innerHTML = `
            <button type="button" onclick="formatText('bold')" title="Negrita">B</button>
            <button type="button" onclick="formatText('italic')" title="Cursiva">I</button>
            <button type="button" onclick="formatText('underline')" title="Subrayado">U</button>
            <button type="button" onclick="insertLink()" title="Enlace">🔗</button>
            <button type="button" onclick="insertList()" title="Lista">•</button>
        `;
        
        textarea.parentNode.insertBefore(toolbar, textarea);
        textarea.classList.add('rich-editor-content');
    });
}
...
function loadContent(url, container) {
    ...
    fetch(url)
        ...
        .catch(error => {
            targetContainer.innerHTML = '<div class="error">Error al cargar el contenido</div>';
