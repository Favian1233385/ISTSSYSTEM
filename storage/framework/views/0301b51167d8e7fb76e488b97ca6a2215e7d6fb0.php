...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="d-flex gap-3 mt-4">
                ...
                <a href="<?php echo e(route('admin.campus-items.index')); ?>" class="btn" style="background: #253b7d; color: #fff; font-weight:600; border-radius:8px; padding:0.75em 2em; font-size:1.1em; min-width:130px; max-width:180px; display:flex; align-items:center; gap:0.5em; justify-content:center;">Cancelar</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\workspace\ISTSSYSTEM\resources\views/admin/campus-items/create.blade.php ENDPATH**/ ?>