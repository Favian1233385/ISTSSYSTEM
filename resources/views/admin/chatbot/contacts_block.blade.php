...
<div class="card">
    <div class="card-body">
        ...
        <div style="margin:1.2rem 0 2.2rem 0;">
            <!-- Fila de filtros -->
            <form method="GET" action="{{ route('admin.chatbot.contacts') }}" class="d-flex flex-row flex-wrap align-items-end" style="gap:1rem; margin-bottom:0;">
            ...
            <div class="d-flex flex-row justify-content-between align-items-center mt-2" style="gap:1rem; width:100%;">
                 <a href="{{ route('admin.chatbot.contacts.export') }}" class="btn btn-success btn-lg fw-semibold m-0">⬇️ Descargar Excel</a>
