            ...
            <div class="admin-content">
                ...
                <form action="<?php echo e(route('admin.news.update', $news['id'])); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="summary" id="summary" class="form-control" rows="3"><?php echo e(old('summary', $news['summary'])); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="content">Contenido</label>
                        <textarea name="content" id="content" class="form-control" rows="10"><?php echo e(old('content', $news['content'])); ?></textarea>
                    </div>
                    <div class="form-group">
...
<?php /**PATH C:\workspace\ISTSSYSTEM\resources\views/admin/crud/news/edit.blade.php ENDPATH**/ ?>