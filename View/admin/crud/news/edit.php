        ...
        <div class="admin-container">
            <div class="admin-content">
                ...
                <div class="form-container">
                    ...
                    <form method="POST" action="<?= APP_URL ?>/news/edit/<?= htmlspecialchars($item["id"] ?? '') ?>" enctype="multipart/form-data" class="styled-form">
                        ...
                        <div class="form-card">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="summary" name="summary" class="form-control" rows="3" required><?= htmlspecialchars($item['summary'] ?? '') ?></textarea>
                            </div>

                            <div class="form-group">
                                <label for="content">Contenido</label>
                                <textarea id="content" name="content" class="form-control" rows="10" required><?= htmlspecialchars($item['content'] ?? '') ?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php if (!empty($item["image_url"])): ?>
                                    <div class="current-image">
                                        <p>Imagen actual:</p>
                                        <img src="<?= APP_URL . htmlspecialchars($item["image_url"]) ?>" alt="Imagen actual" style="max-width: 200px; margin-top: 10px;">
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
