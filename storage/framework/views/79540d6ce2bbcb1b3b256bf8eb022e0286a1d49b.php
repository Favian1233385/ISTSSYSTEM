...
<div class="admin-content">
    ...
    <form class="form-docente" method="POST" action="<?php echo e(route('admin.teachers.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="form-row">
            <div>
        ...
        <button type="submit" class="btn-submit">Añadir Docente</button>
    </form>
</div>
