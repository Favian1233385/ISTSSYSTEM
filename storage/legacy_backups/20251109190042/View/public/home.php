...
<body>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    ...
                    <ul>
                        <li><a href="/reportar-copyright">Reportar Infracción de Derechos de Autor</a></li>
                        <li><a href="/reportar-seguridad">Reportar Problema de Seguridad</a></li>
                        <li><a href="/aviso-marca">Aviso de Marca</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        ...
                        <li><a href="/accesibilidad-digital">Accesibilidad Digital</a></li>
                        <li><a href="/declaracion-privacidad">Declaración de Privacidad</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        <li><a href="/contacto">Contactar ISTS</a></li>
                        <li><a href="/mapas-direcciones">Mapas y Direcciones</a></li>
            ...
            <div class="footer-bottom">
                <p>&copy; <?= date(
                    "Y",
                ) ?> Todos Los derechos Reservados. Autor: Cumbanama</p>
    ...
    <script src="<?= APP_URL ?>/public/js/harvard-interactions.js"></script>
</body>
</html>
