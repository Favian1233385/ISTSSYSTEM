...
<div class="card" style="border-radius: 18px; box-shadow: 0 2px 16px rgba(0,158,96,0.10); margin-top: 2.5rem; max-width: 950px; margin-left:auto; margin-right:auto;">
    <div class="card-body p-5">
        <div class="mb-4 d-flex flex-column flex-md-row align-items-center justify-content-between" style="gap:1.2rem;">
            ...
            <a href="{{ route('about.create') }}" class="btn" style="background: linear-gradient(90deg,#009e60,#f9d423 90%); color: #fff; font-weight:600; box-shadow:0 2px 8px rgba(0,158,96,0.15); border-radius: 8px; padding: 0.75rem 1.5rem; font-size:1.1rem; transition:box-shadow .2s;">Crear Nueva Sección</a>
        </div>
        @if (session('success'))
                    ...
                    <tr>
                        ...
                        <td style="display:flex; flex-direction:column; gap:0.5em; align-items:flex-start;">
                            ...
                            @if (strtolower($about['title']) === 'autoridades')
                                <a href="{{ route('admin.autoridades.create') }}" class="btn" style="background: #009e60; color: #fff; font-weight:600; border-radius:8px; padding:0.5em 1.2em; font-size:1em; min-width:100px; text-align:center;">Crear Autoridad</a>
                            @endif
                            @if (strtolower($about['title']) === 'planta docente')
                                <a href="{{ route('admin.teachers.create') }}" class="btn" style="background: #009e60; color: #fff; font-weight:600; border-radius:8px; padding:0.5em 1.2em; font-size:1em; min-width:100px; text-align:center;">Crear Docente</a>
                            @endif
                        </td>
                    </tr>
                    @empty
