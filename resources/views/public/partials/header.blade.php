...
<header class="header-public">
    {{-- Logo y texto institucional removidos por profesionalismo --}}
    @php
    ...
    <nav class="header-navbar">
        <ul class="header-menu">
                    ...
                    <div class="column">
                        ...
                        <ul>
                            @foreach($allCareers as $career)
                                <li><a href="{{ url('/carrera/' . $career->slug) }}">{{ $career->name }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                    <div class="column">
                        ...
                        <ul>
                            @foreach($courses as $course)
                                <li><a href="{{ url('/contenido/' . $course->slug) }}">{{ $course->title }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
            ...
            <li class="dropdown">
                <a href="javascript:void(0);" class="header-link{{ request()->is('campus*') ? ' active' : '' }}">CAMPUS</a>
                <ul class="dropdown-content">
                    <li><a href="{{ url('/campus/instalaciones') }}">Instalaciones</a></li>
                    <li><a href="{{ url('/campus/servicios') }}">Servicios</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="javascript:void(0);" class="header-link{{ request()->is('transparencia*') ? ' active' : '' }}">TRANSPARENCIA</a>
                <ul class="dropdown-content">
                    @foreach($transparencyContents as $item)
                        <li><a href="{{ url('/transparencia/' . $item->slug) }}">{{ $item->title }}</a></li>
                    @endforeach
                </ul>
            </li>
            <li class="dropdown">
                <a href="javascript:void(0);" class="header-link{{ request()->is('visitar*') ? ' active' : '' }}">VISITAR</a>
                <ul class="dropdown-content">
                    <li><a href="{{ url('/visitar') }}">Visitar ISTS</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="javascript:void(0);" class="header-link{{ request()->is('acerca*') ? ' active' : '' }}">ACERCA</a>
                <ul class="dropdown-content">
                    <li><a href="{{ url('/acerca') }}">Sobre el ISTS</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="javascript:void(0);" class="header-link{{ request()->is('noticias*') ? ' active' : '' }}">NOTICIAS</a>
                <ul class="dropdown-content">
                    <li><a href="{{ url('/noticias') }}">Todas las Noticias</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="javascript:void(0);" class="header-link{{ request()->is('tramites*') ? ' active' : '' }}">TRÁMITES</a>
                <ul class="dropdown-content">
                    @foreach($tramites as $item)
                        <li><a href="{{ url('/tramites/' . $item->slug) }}">{{ $item->title }}</a></li>
                    @endforeach
                </ul>
            </li>
        </ul>
