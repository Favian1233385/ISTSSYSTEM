...
<div class="card" style="border-radius: 18px; box-shadow: 0 2px 16px rgba(0,158,96,0.10); margin-top: 2.5rem;">
    <div class="card-body p-5">
        <div class="mb-4 d-flex flex-column flex-md-row align-items-center justify-content-between" style="gap:1.2rem;">
            ...
            <a href="{{ route('admin.visit-sections.create') }}" class="btn" style="background: linear-gradient(90deg,#009e60,#f9d423 90%); color: #fff; font-weight:600; box-shadow:0 2px 8px rgba(0,158,96,0.15); border-radius: 8px; padding: 0.75rem 1.5rem; font-size:1.1rem; transition:box-shadow .2s;">+ Nueva Sección</a>
        </div>
        @if(session('success'))
                    ...
                    @forelse($sections as $section)
                        <tr style="background: #fff;">
                            ...
                            <td style="display:flex; gap:0.5em;">
                                <a href="{{ route('visitar.section', $section->slug) }}" class="btn" style="background: #253b7d; color: #fff; font-weight:600; border-radius:8px; padding:0.5em 1.2em; font-size:1em; box-shadow:0 2px 8px rgba(37,59,125,0.10);" title="Ver en sitio público" target="_blank">👁️</a>
                                <a href="{{ route('admin.visit-sections.edit', $section->id) }}" class="btn" style="background: #009e60; color: #fff; font-weight:600; border-radius:8px; padding:0.5em 1.2em; font-size:1em; box-shadow:0 2px 8px rgba(0,158,96,0.10);" title="Editar">✏️</a>
