...
<header class="header-public">
    ...
    <nav class="header-navbar" style="width: 100%; background: transparent; box-shadow: none; display: flex; justify-content: center; align-items: center; padding: 0.75rem 0;">
        <div id="mobile-menu-overlay" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(30,30,30,0.25); z-index:9999;"></div>
        <button id="mobile-menu-toggle" class="mobile-menu-toggle" aria-label="Abrir menú" style="display:none; position:absolute; left:1.5rem; top:1.1rem; background:none; border:none; z-index:3001; cursor:pointer;">
            <span style="display:block; width:32px; height:4px; background:#00a86b; margin:6px 0; border-radius:2px;"></span>
            <span style="display:block; width:32px; height:4px; background:#00a86b; margin:6px 0; border-radius:2px;"></span>
            <span style="display:block; width:32px; height:4px; background:#00a86b; margin:6px 0; border-radius:2px;"></span>
        </button>
        <ul id="main-nav-menu" class="header-menu" style="display: flex; flex-direction: row; align-items: center; gap: 2.5rem; list-style: none; margin: 0 auto; padding: 0; justify-content: center; z-index: 10000;">
            ...
            <li class="dropdown" style="position: relative;">
                ...
                <div class="dropdown-content academic-dropdown">
                    <!-- Eliminado fondo y contenedor vacío del header del menú desplegable 'Acerca' -->
            ...
            <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php elseif($title == 'ACADÉMICOS'): ?>
                    <li class="dropdown" style="position: relative;">
                        ...
                        <div class="dropdown-content academic-dropdown">
                            <!-- Eliminado fondo y contenedor vacío del header del menú desplegable 'Académicos' -->
                            <div class="academic-dropdown-columns">
                                <div class="academic-column">
                ...
                <?php elseif($title == 'VISITAR'): ?>
                    ...
                    <li class="dropdown" style="position: relative;">
                        ...
                        <div class="dropdown-content academic-dropdown">
                            <!-- Eliminado fondo y contenedor vacío del header del menú desplegable 'Visitar' -->
                            <div class="academic-dropdown-columns">
                                <div class="academic-column">
                ...
                <?php elseif($title == 'TRANSPARENCIA'): ?>
                    <li class="dropdown" style="position: relative;">
                        ...
                        <div class="dropdown-content academic-dropdown">
                            <!-- Eliminado fondo y contenedor vacío del header del menú desplegable 'Transparencia' -->
                            <div class="academic-dropdown-columns">
                                <div class="academic-column">
                                    <div class="academic-title">Secciones</div>
                                    <div class="academic-underline"></div>
    ...
    <script>
// Lógica para submenús móviles: solo el header-link principal previene navegación, los hijos funcionan
(function() {
  function isMobile() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!navMenu) return;
    navMenu.querySelectorAll('.dropdown > .header-link').forEach(function(link) {
      link.addEventListener('click', function(e) {
        if (!isMobile()) return;
        // Solo prevenir el default si el clic es sobre el header-link, no sobre los hijos
        if (e.target === link) {
          e.preventDefault();
          var parent = link.parentElement;
          // Cierra otros submenús
          navMenu.querySelectorAll('.dropdown').forEach(function(drop) {
            if (drop !== parent) drop.classList.remove('open-mobile');
          });
          // Toggle del submenú actual
          parent.classList.toggle('open-mobile');
        }
        // Si el target es un enlace dentro del dropdown-content, dejar que navegue normalmente
      });
    });
  });
})();
