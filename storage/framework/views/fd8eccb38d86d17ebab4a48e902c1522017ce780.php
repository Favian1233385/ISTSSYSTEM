        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.autoridades.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="categoria" id="categoria" class="form-control" value="<?php echo e(old('categoria')); ?>" placeholder="Ej: Directivos, OCS" required>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\workspace\ISTSSYSTEM\resources\views/admin/autoridades/create.blade.php ENDPATH**/ ?>