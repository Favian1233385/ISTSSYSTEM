...
<div class="admin-content">
    <div class="dashboard-header">
        ...
        <p>Configura el enlace externo que aparecerá en el menú Campus del sitio público.</p>
    </div>
        ...
        <div class="card-body">
            <form action="{{ route('admin.settings.biblioteca.update') }}" method="POST">
                ...
                <div class="alert alert-info mt-3">
                    <strong>ℹ️ Nota:</strong> Este enlace se abrirá en una nueva pestaña cuando los usuarios hagan clic en "Biblioteca" desde el menú Campus.
                </div>
